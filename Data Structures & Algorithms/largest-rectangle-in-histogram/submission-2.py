class Solution:
    def largestRectangleArea(self, heights: List[int]) -> int:
        ...
        #REVISIT PROBLEM (wrong) (main issue: had right idea for left right logic, stored the areas at start instead of left right indices, and using those to calculate area per bar and using max)
        n = len(heights)
